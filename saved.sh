...
CHPL_RT_NUM_THREADS_PER_LOCALE=MAX_LOGICAL ./amatter.x --boundary=4 --np=120 --nworms=800 --kbt=0.6 --fluid_rho=0.05 --dt=0.005 --save_interval=100 --nsteps=24000000 --L=6.4 --gamma=24.0 --fdrag=0.04
