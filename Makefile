...
CHPLFLAGS = --fast --savec=$(BUILDDIR) --optimize --vectorize --specialize --optimize-loop-iterators --optimize-forall-unordered-ops --print-passes --print-commands --print-callstack-on-error
