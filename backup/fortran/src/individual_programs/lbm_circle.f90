...
!    use omp_lib ! OpenMP paralellism
    ...
    integer(int64),parameter :: nsteps = 100!20000
    ...
    allocate(rho(0:nx,0:ny))
    allocate(vel(0:nx,0:ny,2))
    allocate(f_new(9,0:nx,0:ny))
    allocate(f_old(9,0:nx,0:ny))
    allocate(mask(0:nx,0:ny))
