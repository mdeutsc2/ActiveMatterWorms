...
proc calc_forces_parallel() {
    ...
    forall ibin in 2..numBins by 2 { // can we do this with every i, but every other j?
        for jbin in 1..numBins {
            var binid=(jbin-1)*numBins+ibin;
            var binidnbor = bins[binid].neighbors[2];
